peacekeeper_corpus_juris = class({})
LinkLuaModifier( "modifier_corpus_jurius", "heroes/peacekeeper/peacekeeper_corpus_juris.lua" ,LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------------------
function peacekeeper_corpus_juris:OnSpellStart()
